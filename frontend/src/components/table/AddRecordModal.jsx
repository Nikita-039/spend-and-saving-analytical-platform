...
export default function AddRecordModal({ isOpen, onClose, onSuccess }) {
  ...
  return (
    ...
    >
      ...
      {/* Row 2: Department + Business Unit */}
      <div className="form-row">
        ...
        <Field name="businessUnit" label="Business Unit" required>
      ...
      <div className="form-row">
        ...
        <Field name="vendor" label="Vendor" required>
      ...
      <div className="form-row">
        ...
        <Field name="actualSpend" label="Actual Spend (₹)" required>
